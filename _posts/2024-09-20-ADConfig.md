...
categories: [IT, Active Directory]
tags: [cloud, azure, ad]     # TAG names should always be lowercase
description: This lab goes through the implementation of configuring Active Directory with Azure Virtual Machines. We will be configuring a domain controller and a client.
---
